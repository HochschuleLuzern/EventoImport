...
class CreateSingleEvent extends EventAction
{
    ...
    {
        parent::__construct($evento_event, $event_object_factory, \ilEventoImportLogger::CREVENTO_MA_SINGLE_EVENT_CREATED, $event_settings, $repository_facade, $user_facade, $logger, $rbac_services);
